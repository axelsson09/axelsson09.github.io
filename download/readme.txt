...
1. **Installation:**
   ...
   - Run the installer or executable file (if applicable).
   - Follow the on-screen instructions to complete the installation.

2. **Getting Started:**
   - Once installed, launch Glosplugare from the Start Menu or the desktop shortcut.
   - Explore the features and customize settings according to your preferences.

3. **Documentation:**
   - For detailed information and usage instructions, refer to the documentation.
   - Documentation files may be available in the "docs" folder or on our website: https://axelsson09.github.io/documentation.html

4. **Support:**
   - If you encounter any issues or have questions, check our FAQ section on the website or contact our support team: https://axelsson09.github.io/support.html
